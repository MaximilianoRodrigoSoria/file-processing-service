package com.ar.laboratory.fileprocessingservice.shared.infrastructure.metrics;
...
public class UseCaseMetricsAspect {
     ...
     */
    @Around(
            "execution(* com.ar.laboratory.fileprocessingservice..application.inbound.command..*(..))"
                    + " && !within(com.ar.laboratory.fileprocessingservice..infrastructure..*)")
