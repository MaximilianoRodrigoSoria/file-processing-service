package com.ar.laboratory.fileprocessingservice.example.infrastructure.web.controller;
...
import com.ar.laboratory.fileprocessingservice.example.application.inbound.command.CreateExampleCommand;
import com.ar.laboratory.fileprocessingservice.example.application.inbound.command.FindExampleByDniCommand;
import com.ar.laboratory.fileprocessingservice.example.application.inbound.command.ListExamplesCommand;
import com.ar.laboratory.fileprocessingservice.example.application.query.ExampleFilter;
import com.ar.laboratory.fileprocessingservice.example.domain.exception.ExampleAlreadyExistsException;
import com.ar.laboratory.fileprocessingservice.example.domain.exception.ExampleNotFoundException;
import com.ar.laboratory.fileprocessingservice.example.domain.model.Example;
import com.ar.laboratory.fileprocessingservice.example.infrastructure.inbound.web.controller.ExampleController;
import com.ar.laboratory.fileprocessingservice.example.infrastructure.inbound.web.dto.CreateExampleRequest;
import com.ar.laboratory.fileprocessingservice.example.infrastructure.inbound.web.dto.ExampleResponse;
import com.ar.laboratory.fileprocessingservice.example.infrastructure.inbound.web.mapper.ExampleDtoMapper;
import com.ar.laboratory.fileprocessingservice.shared.infrastructure.config.GlobalExceptionHandler;
